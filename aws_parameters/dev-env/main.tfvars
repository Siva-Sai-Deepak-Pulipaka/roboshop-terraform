parameters = [
    { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.easydevops.online:80/", type = "String" },
    { name = "dev.frontend.user_url", value = "http://user-dev.easydevops.online:80/", type = "String" },
    { name = "dev.frontend.cart_url", value = "http://cart-dev.easydevops.online:80/", type = "String" },
    { name = "dev.frontend.shipping_url", value = "http://shipping-dev.easydevops.online:80/", type = "String" },
    { name = "dev.frontend.payment_url", value = "http://payment-dev.easydevops.online:80/", type = "String" },
    ...
    { name = "dev.shipping.cart_endpoint", value = "cart-dev.easydevops.online:80", type = "String" },
